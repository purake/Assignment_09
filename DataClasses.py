...
# class to handle tracks
# PMoy, 2022-Sep-02, Added Track class properties
# ------------------------------------------#
...
class Track():
    ...
    # -- Methods -- #
    def __str__(self):
        """Return Track details as formatted string."""
        return '{:>2}. {} ({})'.format(self.position, self.title, self.length)

    def get_record(self) -> str:
        """Return Track record formatted for saving to file."""
